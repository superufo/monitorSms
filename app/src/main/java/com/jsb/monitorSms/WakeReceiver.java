...
public class WakeReceiver extends BroadcastReceiver {
    ...
    private final static String TAG  = "test"; // WakeReceiver.class.getSimpleName();
    ...
    public static class WakeNotifyService extends Service {
        ...
        public int onStartCommand(Intent intent, int flags, int startId) {
            ...
            if (Build.VERSION.SDK_INT < 18) {
                ...
                Intent innerIntent = new Intent(this, WakeMonSmsInnerService.class);
     ...
     */
    public static class WakeMonSmsInnerService extends Service {
